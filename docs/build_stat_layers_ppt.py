...
table(s, Inches(0.7), Inches(1.80),
      ["層／方法", "AUC", "精確率", "召回率", "large", "medium", "small"],
      [["基線 純|Δa| 絕對門檻", "0.870", "0.324", "0.263", "0.353", "0.072", "0.091"],
       ["基線 僅阻力模型", "0.856", "0.294", "0.228", "0.321", "0.033", "0.000"],
       ["基線 σ 正規化|Δa|", "0.878", "0.335", "0.276", "0.363", "0.099", "0.000"],
       ["L1 規則 P1–P6", "—", "0.299", "0.251", "0.333", "0.083", "0.000"],
       ["L2 CUSUM（最佳單通道）", "0.899", "0.473", "0.492", "0.467", "0.575", "0.091"],
       ["L2 五通道樸素 max", "0.831", "0.286", "0.219", "0.314", "0.022", "0.000"],
       ["L3 融合評分器 OOF", "0.986", "0.634", "0.950", "0.975", "0.945", "0.091"],
       ["naive 隨機（對照）", "—", "0.082", "0.049", "0.050", "0.046", "0.036"]],
      [Inches(3.5), Inches(1.2), Inches(1.4), Inches(1.4), Inches(1.4), Inches(1.4), Inches(1.4)],
      size=11.5, rh=Inches(0.355), hi_rows=(6,))
_txt(s, Inches(0.7), Inches(5.15), Inches(11.9), Inches(2.0),
     [[("L2 四通道同一擂台 AUC：CUSUM 0.899 ＞ 3σ-MAD 0.858 ＞ SSA 0.818 ＞ BOCPD 0.725", 13.5, ACCENT2, True)],
      [("——四法各有盲區、皆無法單獨涵蓋，正是 L3 融合的動機（融合後 AUC 0.986）。", 13, INK, False)],
      [("基線階梯：σ 正規化 0.878 ＞ 純絕對 0.870（驗證 σ 正規化）；三基線與樸素 max 皆遠低於 L3 0.986。", 13, ACCENT, False)],
      [("naive 隨機僅召回 0.049 ", 13.5, GOOD, True),
       ("——證明擂台具鑑別力；同標準下 L3 ＞ L2 ＞ 基線 ＞ L1 ＞ naive。僅 Starlink，非取代上頁口徑聲明。", 12.5, INK, False)]], sp=1.28)
_footer(s, 22)
